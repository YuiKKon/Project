...
public class Level5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogfon.setBackgroundResource(R.drawable.preview_background_6);

        //описание задания
        TextView textdescription = dialog.findViewById(R.id.texxtdescription);
        textdescription.setText(R.string.level5);
        ...
        textdiscriptionEnd.setText(R.string.level5_end);
        ...
        numLeft = random.nextInt(10); //случайное число с 1 до 10
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (count == 20) {
                        ...
                        numLeft = random.nextInt(10); //случайное число с 0 до 9
                        img_left.setImageResource(array.images5[numLeft]); // достаем из массива картинку
